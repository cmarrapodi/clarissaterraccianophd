...
// ─── Design tokens ────────────────────────────────────────────────────────────
// Primary:   #5C2D82  (plum)
// Dark:      #3B1A55  (plum-dark)
// Mid:       #9B6BBD  (plum-mid)
// Light:     #F2EBF8  (plum-light)
// Ink:       #0D0D0D
// Off-white: #F9F6F2
// Muted:     #666666
// ─────────────────────────────────────────────────────────────────────────────
...
function MarqueeStrip() {
  ...
  return (
    <div
      style={{ background: "#5C2D82", borderTop: "0.5px solid rgba(255,255,255,0.1)", borderBottom: "0.5px solid rgba(255,255,255,0.1)", overflow: "hidden", whiteSpace: "nowrap", padding: "14px 0" }}
    >
      <motion.div
      ...
      >
        {doubled.map((item, i) => (
          <span
            key={i}
            style={{ fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.65)" }}
          >
            {item}
            {i < doubled.length - 1 && (
...
function SectionLabel({ children, light = false }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
      <div style={{ width: "20px", height: "1.5px", background: light ? "#9B6BBD" : "#9B6BBD", borderRadius: "2px", flexShrink: 0 }} />
  ...
  return (
    <div style={{ background: "#F9F6F2", color: "#0D0D0D", minHeight: "100vh", fontFamily: "inherit", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        padding: "1.25rem 2.5rem", borderBottom: "0.5px solid rgba(0,0,0,0.09)",
        background: "rgba(249,246,242,0.92)", backdropFilter: "blur(10px)",
        position: "sticky", top: 0, zIndex: 50,
      }}>
        <div style={{ fontSize: "15px", fontWeight: 500, letterSpacing: "0.06em" }}>
        ...
        <button style={{
          background: "#5C2D82", color: "#fff", border: "none",
      ...
      <section style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", minHeight: "88vh" }}>
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            style={{ fontSize: "clamp(36px, 4vw, 52px)", fontWeight: 400, lineHeight: 1.08, letterSpacing: "-0.02em", color: "#0D0D0D", marginBottom: "2rem" }}
          >
          ...
          <motion.p
            variants={fadeUp}
            style={{ fontSize: "15px", lineHeight: 1.85, color: "#666", maxWidth: "420px", marginBottom: "2.5rem" }}
          >
            Dr. Clarissa Terracciano partners with families, educators, and institutions to design
            high-impact educational pathways grounded in two decades of expertise.
          </motion.p>
          ...
          <motion.div variants={fadeUp} style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "2.5rem" }}>
            {heroTags.map((tag) => (
              <span
                key={tag}
                style={{
                  background: "#F2EBF8", color: "#3B1A55",
          ...
          <motion.div variants={fadeUp} style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            <button style={{
              background: "#5C2D82", color: "#fff",
              padding: "14px 30px", fontSize: "12px", letterSpacing: "0.1em",
            ...
            <button style={{
              ...
              padding: "14px 30px", fontSize: "12px", letterSpacing: "0.1em",
              textTransform: "uppercase", border: "0.5px solid rgba(0,0,0,0.25)",
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            <div style={{
              display: "inline-block", background: "rgba(155,107,189,0.3)", color: "#F2EBF8",
              fontSize: "11px", letterSpacing: "0.1em", textTransform: "uppercase",
              padding: "6px 14px", borderRadius: "100px", marginBottom: "1.25rem",
            }}>
              Ph.D. · Licensed NY & CO
            </div>
            <div style={{ fontSize: "26px", fontWeight: 300, color: "#fff", letterSpacing: "-0.01em", marginBottom: "4px" }}>
              Dr. Clarissa Terracciano
            </div>
            <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.45)", letterSpacing: "0.08em" }}>
              Educational Consultant · 20 Years Experience
            </div>
          </div>
        </motion.div>
      </section>
      ...
      <section id="about" style={{ padding: "6rem 2.5rem" }}>
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            style={{ fontSize: "clamp(28px, 3vw, 38px)", fontWeight: 400, letterSpacing: "-0.02em", lineHeight: 1.1, color: "#0D0D0D", marginBottom: "1.5rem", maxWidth: "560px" }}
          >
            A career built on{" "}
          ...
          <motion.p
            variants={fadeUp}
            style={{ fontSize: "15px", lineHeight: 1.85, color: "#666", maxWidth: "640px", marginBottom: "4rem" }}
          >
            Dr. Clarissa Terracciano believes that education has the power to meaningfully shape
            confidence, opportunity, growth, and long-term life outcomes. Her consulting work is
            designed to bring clarity, expertise, and strategic direction to families, educators,
            and organizations seeking thoughtful, research-informed educational guidance.
          </motion.p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", border: "0.5px solid rgba(0,0,0,0.1)" }}>
            {expertiseAreas.map((area, index) => (
              <motion.div
                ...
                style={{
                  padding: "2.5rem 2rem",
                  borderRight: index < expertiseAreas.length - 1 ? "0.5px solid rgba(0,0,0,0.1)" : "none",
                }}
              >
                <div style={{ fontSize: "11px", letterSpacing: "0.15em", color: "#9B6BBD", fontWeight: 500, marginBottom: "1.25rem" }}>
                  {area.num}
                </div>
                <div style={{ width: "32px", height: "2px", background: "#5C2D82", borderRadius: "2px", marginBottom: "1.25rem" }} />
                <div style={{ fontSize: "16px", fontWeight: 500, color: "#0D0D0D", marginBottom: "1rem", lineHeight: 1.35 }}>
                  {area.title}
                </div>
                <div style={{ fontSize: "13px", lineHeight: 1.85, color: "#666" }}>
                  {area.description}
                </div>
              </motion.div>
            ))}
      ...
      <motion.section
        ...
        style={{
          background: "#F2EBF8",
          borderTop: "0.5px solid rgba(92,45,130,0.12)",
          borderBottom: "0.5px solid rgba(92,45,130,0.12)",
          padding: "5rem 2.5rem",
        }}
      >
        <div style={{ maxWidth: "800px" }}>
          ...
          <p style={{ fontSize: "clamp(20px, 2.5vw, 28px)", fontWeight: 300, lineHeight: 1.5, color: "#3B1A55", fontStyle: "italic", letterSpacing: "-0.01em" }}>
            "True educational growth requires more than generic solutions — it requires someone who
            understands the whole learner, the full system, and the long road ahead."
          </p>
          <div style={{ marginTop: "1.5rem", fontSize: "12px", letterSpacing: "0.15em", textTransform: "uppercase", color: "#9B6BBD" }}>
            — Dr. Clarissa Terracciano
          </div>
        </div>
      </motion.section>
      ...
      <section
        id="services"
        style={{ background: "#1A0F24", padding: "6rem 2.5rem" }}
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            style={{ fontSize: "clamp(28px, 3vw, 38px)", fontWeight: 400, letterSpacing: "-0.02em", lineHeight: 1.1, color: "#fff", marginBottom: "4rem", maxWidth: "560px" }}
          >
            High-level consulting designed to create{" "}
            <em style={{ fontStyle: "italic", fontWeight: 300, color: "#9B6BBD" }}>clarity</em> and results.
          </motion.h2>
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ background: "rgba(92,45,130,0.2)" }}
                  style={{
                    padding: "2.5rem",
                    borderRight: !isRightCol ? "0.5px solid rgba(255,255,255,0.07)" : "none",
                    borderBottom: !isLastRow ? "0.5px solid rgba(255,255,255,0.07)" : "none",
                    transition: "background 0.2s",
                  }}
                >
                  <div style={{
                    width: "40px", height: "40px", borderRadius: "8px",
                    background: "rgba(92,45,130,0.35)", display: "flex",
                    alignItems: "center", justifyContent: "center", marginBottom: "1.5rem",
                  }}>
                    <Icon size={18} color="#F2EBF8" />
                  </div>
                  <div style={{ fontSize: "16px", fontWeight: 500, color: "#fff", marginBottom: "0.75rem" }}>
                    {service.title}
                  </div>
                  <div style={{ fontSize: "13px", lineHeight: 1.85, color: "rgba(255,255,255,0.45)" }}>
                    {service.description}
                  </div>
                </motion.div>
              );
      ...
      <section style={{ padding: "6rem 2.5rem" }}>
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            style={{ fontSize: "clamp(28px, 3vw, 38px)", fontWeight: 400, letterSpacing: "-0.02em", lineHeight: 1.1, color: "#0D0D0D", marginBottom: "3rem", maxWidth: "500px" }}
          >
            Strategic expertise for{" "}
            <em style={{ fontStyle: "italic", fontWeight: 300, color: "#5C2D82" }}>meaningful</em> educational growth.
          </motion.h2>
            ...
            {values.map((value, i) => (
              <motion.div
                ...
                style={{
                  ...
                  background: "#F2EBF8",
                  border: "0.5px solid rgba(92,45,130,0.12)",
                  borderRadius: "6px",
                }}
              >
        ...
        >
          <motion.div
            ...
            style={{
              ...
              background: "#F2EBF8", display: "flex", alignItems: "center",
          ...
          <motion.h2
            variants={fadeUp}
            style={{ fontSize: "clamp(32px, 4vw, 46px)", fontWeight: 400, letterSpacing: "-0.025em", color: "#0D0D0D", marginBottom: "1.5rem", lineHeight: 1.08 }}
          >
            Bring expert insight into your{" "}
            <em style={{ fontStyle: "italic", fontWeight: 300, color: "#5C2D82" }}>learner's</em> journey.
          </motion.h2>
          <motion.p
            variants={fadeUp}
            style={{ fontSize: "15px", color: "#666", marginBottom: "3rem", maxWidth: "520px", margin: "0 auto 3rem" }}
          >
            Book a consultation for thoughtful, research-informed educational guidance tailored to
            your learner, family, school, or organization.
          </motion.p>
          <motion.div variants={fadeUp} style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <button style={{
              background: "#5C2D82", color: "#fff",
              padding: "15px 32px", fontSize: "12px", letterSpacing: "0.1em",
              textTransform: "uppercase", border: "none", borderRadius: "3px", cursor: "pointer",
              display: "flex", alignItems: "center", gap: "8px",
            }}>
      ...
      <footer style={{
        ...
        <div style={{ fontSize: "13px", fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase" }}>
          Clarissa Terracciano
        </div>
        <div style={{ fontSize: "12px", color: "#aaa", letterSpacing: "0.04em" }}>
          Learning · Literacy · Special Education · Curriculum · EdTech · Policy
        </div>
