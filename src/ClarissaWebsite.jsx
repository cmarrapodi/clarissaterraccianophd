...
const expertiseAreas = [
  {
    ...
    description:
      "A foundational grounding in how children grow, think, and learn — informing every consultation with a deep understanding of child development, cognition, and the psychological dimensions of education.",
  },
  {
    num: "02",
    ...
    description:
      "Graduate training at one of the world's foremost schools of education, specializing in inclusive practices and teaching students with disabilities — bridging research and real-world classroom application.",
  },
  {
    num: "03",
    ...
    description:
      "Doctoral research examining the policies governing emerging and innovative technology and digital infrastructure in education — positioning Dr. Terracciano at the intersection of educational leadership and the future of learning.",
  },
];
    ...
    <div style={{ background: "#F9F6F2", color: "#0D0D0D", minHeight: "100vh", fontFamily: "inherit", overflowX: "hidden" }}>
      ...
      <section id="about" style={{ padding: "6rem 2.5rem" }}>
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }} variants={stagger}>
          ...
          <motion.p variants={fadeUp} style={{ fontSize: "15px", lineHeight: 1.85, color: "#666", maxWidth: "640px", marginBottom: "4rem" }}>
            Two decades into her career, she pursued her doctorate — earning a Ph.D. in Educational Leadership and Policy Studies, with research focused on the policies shaping emerging technology and digital infrastructure in education. It is the natural culmination of a life's work: understanding not just how individuals learn, but how the systems around them must evolve to keep pace with the future. That full arc — from a summer camp in New York City to the frontier of educational policy — is what she brings to every family, educator, and organization she works with today.
          </motion.p>
      ...
      <footer style={{ borderTop: "0.5px solid rgba(0,0,0,0.09)", padding: "2rem 2.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
          ...
          <a href="/admin" style={{ fontSize: "11px", color: "rgba(0,0,0,0.15)", textDecoration: "none", letterSpacing: "0.06em" }}>·</a>
        </div>
      </footer>
    </div>
  );
